...
def main():
    ...
    # Calculate metrics
    results_df = calculate_metrics(price_allocation_df, hotels_df)
    ...
    display_with_description(allocation_description, price_allocation_df.head(), allocation_post_description)
    ...
    csv_path, txt_path = save_files(price_allocation_df, results_df)
