...
# che il separatore deve essere '\t' che è il tab per identificare questa distinzione.
    ...
    def easy(self):
        title_basics_questions, title_basics_answers = self.title_basics_qa(self.filter_sort_data_tb('easy'), 2, 2)
        info_person_questions, info_person_answers = self.info_person_qa(self.filter_sort_data_ip('easy'), 2, 2)
    ...
    def medium(self):
        title_basics_questions, title_basics_answers = self.title_basics_qa(self.filter_sort_data_tb('medium'), 2, 2)
        info_person_questions, info_person_answers = self.info_person_qa(self.filter_sort_data_ip('medium'), 2, 2)
    ...
    def difficult(self):
        title_basics_questions, title_basics_answers = self.title_basics_qa(self.filter_sort_data_tb('difficult'), 2, 2)
        info_person_questions, info_person_answers = self.info_person_qa(self.filter_sort_data_ip('difficult'), 2, 2)
